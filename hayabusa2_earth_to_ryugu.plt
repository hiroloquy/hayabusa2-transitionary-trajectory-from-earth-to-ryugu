# -------------------- Setting ------------------- #
reset
set terminal gif animate optimize delay 5 size 1280, 720
set output "hayabusa2_orbit_graph.gif"
...
do for[i=0:1832]{
    ...
    # Right side: Distance between Hayabusa2 and Ryugu
        ...
        splot[0:2000][0:40000][-0.15:0.15] \
            ...
            data_txt every ::0+i::0+i using 2:14:5 w p pt 7 ps 1 lc rgb "black" notitle
